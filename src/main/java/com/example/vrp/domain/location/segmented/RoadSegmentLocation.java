...
package com.example.vrp.domain.location.segmented;

import java.util.Map;

import com.example.vrp.domain.location.DistanceType;
import com.example.vrp.domain.location.Location;
import com.example.vrp.domain.location.RoadLocation;
